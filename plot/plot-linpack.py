...
df = pd.read_csv('../data/linpack.csv')
print(df.to_string())
print(len(df))
...
plt.savefig("../graphs-cpu/linpack-size-exectime.png", dpi=300, bbox_inches='tight')
...
plt.savefig("../graphs-cpu/linpack-size-memutil.png", dpi=300, bbox_inches='tight')
...
ax.set_ylabel("Execution Time (s)")
plt.savefig("../graphs-cpu/linpack-cpucount-exec.png", dpi=300, bbox_inches='tight')
...
plt.savefig("../graphs-cpu/linpack-size-cpuutil.png", dpi=300, bbox_inches='tight')